...
// @desc      Backend API Route - Add education to profile
// @access    Private
...
// @desc      Backend API Route - Delete experience from profile
// @access    Private
router.delete(
  '/experience/:exp_id',
...
// @desc      Backend API Route - Delete education from profile
// @access    Private
router.delete(
  '/education/:edu_id',
  passport.authenticate('jwt', { session: false }),
...
// @desc      Backend API Route - Delete user and profile
// @access    Private
